	...
	<div id="container">
		...
		<div id="midbar">
			<div id="midblock">
				...
				<div id="lowerblock">
					<div id="lowheader">Add CD</div>
					<form action="server" method="POST">
						<div id="formdiv">
							<div class="w3-half">
								<label><b>Title</b></label><br> <input type="text"
									placeholder="Title" name="titlefieldcdadd" required><br>
								<label><b>Duration</b></label><br> <input type="text"
									placeholder="Duration" name="lengthfieldcdadd" required><br>
								<label><b>Genre</b></label><br> <input type="text"
									placeholder="Genre" name="genrefieldcdadd" required><br>
							</div>
							<div class="w3-half">
								<label><b>Tracks</b></label><br> <input type="text"
									placeholder="Tracks" name="tracksfieldcdadd" required><br>

								<label><b>Artists</b></label><br> <input type="text"
									placeholder="Artists" name="artistsfieldcdadd"
									required><br>
								<button type="submit" name="tablebut" value="submitcdadd">Add</button>
							</div>
						</div>
					</form>
				</div>
