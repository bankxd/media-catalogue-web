		...
		<div id="midbar">
			<div id="midblock">
				...
				<div id="upperblock">
					...
					<div style="height: 35px; font-size: 12px; vertical-align: middle; margin: 1px;">
						<form action="server" method="POST">
							<input type="radio" id="dvd" style="vertical-align: middle;margin: 0px;margin-left: -1px;"
								name="tablebut" value="adddvd" onclick="this.form.submit()"> <label for="dvd">DVD</label><br>
							<input type="radio" id="cd" style="vertical-align: middle; margin: 0px; margin-left: -10px;"
								name="tablebut" value="addcd" onclick="this.form.submit()"> <label for="cd">CD</label>
								
						</form>
					</div>
				</div>
				<div id="lowerblock">
					<div id="lowheader"></div>
				</div>
				<hr>
			</div>
		</div>
